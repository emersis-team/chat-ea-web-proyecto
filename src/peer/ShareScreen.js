...
var ShareScreen = /** @class */ (function () {
    ...
    ShareScreen.prototype.disconnectCall = function () {
        this.leave = true;
        this.localVideo.getTracks().forEach(function (track) { return track.stop(); });
        this.room.leaveRoom(this.usernameFrom);
        delete CallHelper.remoteSources[this.usernameFrom];
    };
    ShareScreen.prototype.call = function (usernameTo) {
        try {
